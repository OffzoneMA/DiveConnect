...
router.get("/user", [authenticateUser,divingCenterController.getDivingCenterUser,]);
...
router.post("/addviaapi",  divingCenterController.submitDivingCenter);
...
router.get("/:id/bookings/:bookingId",divingCenterController.getDivingCenterBooking);
router.put("/:id/bookings/:bookingId",divingCenterController.updateDivingCenterBooking);
router.delete("/:id/bookings/:bookingId",divingCenterController.deleteDivingCenterBooking);
